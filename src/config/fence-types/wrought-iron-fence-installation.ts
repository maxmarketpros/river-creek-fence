...
const config: FenceTypeConfig = {
  ...
  h1: "Wrought Iron Fencing in Central Kansas",
  metaTitle: "Wrought Iron Fence Installation | River Creek Fence",
  excerpt:
  ...
  overviewHeading: "Old-World Iron, Built to Outlast the House",
  description: [
  ...
  atAGlance: [
    { icon: "CalendarClock", label: "Lifespan", value: "40+ years" },
    { icon: "Wrench", label: "Upkeep", value: "Recoat 5+ yrs" },
    { icon: "ShieldCheck", label: "Strength", value: "Heavy-gauge" },
    { icon: "Crown", label: "Best for", value: "Estates" },
  ],

  prosConsHeading: "Is Wrought Iron the Right Fence for Your Property?",
  pros: [
  ...
  featureHeading: "Engineered for Kansas Wind, Soil, and Sun",
  featureBody: [
  ...
  useCases: {
    ...
    heading: "Where Wrought Iron Fencing Earns Its Keep",
    subtitle:
    ...
    items: [
      {
        title: "Estate & Front-Yard Framing",
        description:
      ...
      {
        title: "Other Metal Fence Options",
        description:
      ...
      {
        title: "Decorative & Ornamental Lines",
        description:
  ...
  buildStepsHeading: "How We Install Your Wrought Iron Fence",
  buildSteps: [
    {
      title: "Free On-Site Estimate & Design",
      description:
    ...
    {
      title: "Hang Panels & Brace the Gates",
      description:
  ...
  faqs: [
    {
      question: "How long does a wrought iron fence last in Kansas?",
      answer:
    ...
    {
      question: "Does a wrought iron fence rust?",
      answer:
    ...
    {
      question: "Wrought iron or aluminum — which should I choose?",
      answer:
    ...
    {
      question: "Does an iron fence give me any privacy?",
      answer:
  ...
  ctaHeading: "Ready to Frame Your Property in Iron?",
  ctaText:
    "Get a free, no-pressure estimate on a custom wrought iron fence built for Central Kansas weather and finished to last. Call Cody today.",
