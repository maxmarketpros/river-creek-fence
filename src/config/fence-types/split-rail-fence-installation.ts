...
const config: FenceTypeConfig = {
  ...
  title: "Split Rail Fence Installation",
  h1: "Split Rail Fencing in Central Kansas",
  metaTitle: "Split Rail Fence Installation | River Creek Fence",
  excerpt:
  ...
  overviewHeading: "Mark the Line, Keep the View",
  description: [
  ...
  atAGlance: [
    { icon: "CalendarClock", label: "Lifespan", value: "15–25 years" },
    { icon: "Wrench", label: "Upkeep", value: "Low" },
    { icon: "Layers", label: "Style", value: "2-, 3- or 4-rail" },
    { icon: "Trees", label: "Best for", value: "Acreage" },
  ],

  prosConsHeading: "Is a Split Rail Fence the Right Look for Your Land?",
  pros: [
  ...
  featureHeading: "Built to Stand in Kansas Wind and Soil",
  featureBody: [
  ...
  useCases: {
    ...
    heading: "What Kansas Property Owners Use Split Rail For",
    subtitle:
      "From a long acreage boundary to a tidy garden border, here's where a split rail fence earns its keep across Central Kansas.",
    items: [
      {
        title: "Acreage & Property Lines",
        description:
          "Mark a long boundary or driveway entrance with a rustic line that defines the land without closing it in.",
        icon: "Trees",
        href: "/property/acreage-fence-installation",
      },
      {
        title: "Garden & Yard Borders",
        description:
          "A low two-rail run edges flower beds, gardens, and front yards with country charm and an open feel.",
        icon: "Leaf",
        href: "/property/garden-fence-installation",
      },
      {
        title: "Rustic Home Frontage",
        description:
          "Frame a farmhouse or ranch-style home with a split rail line that adds curb appeal and resale value.",
        icon: "Home",
        href: "/services/residential-fence-installation",
      },
      {
        title: "Ranch & Rail Styling",
        description:
          "Prefer a crisp, uniform ranch-rail look? We build clean post-and-rail fences in the same rustic family.",
        icon: "Tractor",
        href: "/fence-types/wood-ranch-rail-fencing",
      },
      {
        title: "Light Animal Control",
        description:
          "Add welded-wire mesh behind the rails to keep dogs, goats, or small livestock in while keeping the open look.",
        icon: "Dog",
        href: "/property/horse-fence-installation",
      },
      {
        title: "Other Wood Fence Styles",
        description:
          "Want more privacy or a different profile? We build picket, privacy, and the full range of wood fencing.",
        icon: "Fence",
  ...
  buildStepsHeading: "How We Install Your Split Rail Fence",
  buildSteps: [
    {
  ...
  faqs: [
    {
      question: "How long does a split rail fence last in Kansas?",
      answer:
    ...
    {
      question: "Will a split rail fence keep my dog in the yard?",
      answer:
    ...
    {
      question: "How many rails should I choose — two, three, or four?",
      answer:
    ...
    {
      question: "Does a split rail fence work on a slope or hilly ground?",
      answer:
  ...
  ctaHeading: "Ready to Frame Your Property the Country Way?",
  ctaText:
  ...
  related: [
    { label: "Acreage Fence Installation", href: "/property/acreage-fence-installation" },
