...
const config: FenceTypeConfig = {
  ...
  title: "Wood Ranch Rail Fencing",
  h1: "Wood Ranch Rail Fencing in Central Kansas",
  metaTitle: "Wood Ranch Rail Fencing in Kansas | River Creek Fence",
  excerpt:
  ...
  overviewHeading: "The Fence That Says This Land Is Spoken For",
  description: [
  ...
  atAGlance: [
    ...
    { icon: "Wrench", label: "Upkeep", value: "Low–moderate" },
    { icon: "Grid3x3", label: "Rails", value: "2, 3, or 4" },
    { icon: "Tractor", label: "Best for", value: "Acreage" },
  ],

  prosConsHeading: "Is Wood Ranch Rail the Right Fence for Your Place?",
  pros: [
  ...
  featureHeading: "Built for Kansas Wind, Soil, and Livestock",
  featureBody: [
  ...
  useCases: {
    ...
    heading: "What Folks Use Wood Ranch Rail Fencing For",
    subtitle:
    ...
    items: [
      ...
      {
        title: "Two-Rail Split Rail Look",
        description:
  ...
  buildStepsHeading: "How We Build Your Wood Ranch Rail Fence",
  buildSteps: [
    {
    ...
    {
      title: "Hang Rails & Brace the Corners",
      description:
  ...
  faqs: [
    {
      question: "How many rails do I need for my property?",
      answer:
    ...
    {
      question: "Will a wood rail fence actually hold horses and cattle?",
      answer:
    ...
    {
      question: "How long does a wood ranch rail fence last in Kansas?",
      answer:
    ...
    {
      question: "Do I have to stain or seal a rail fence?",
      answer:
  ...
  ctaHeading: "Ready to Draw a Clean Line on Your Land?",
  ctaText:
    "Get a free, no-pressure estimate on a wood ranch rail fence built for Central Kansas pastures and acreage. Call Cody today.",
  ...
  related: [
    ...
    { label: "Split Rail Fence Installation", href: "/fence-types/split-rail-fence-installation" },
