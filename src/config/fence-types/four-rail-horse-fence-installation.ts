...
const config: FenceTypeConfig = {
  ...
  title: "Four-Rail Horse Fence Installation",
  h1: "Four-Rail Horse Fencing in Central Kansas",
  metaTitle: "Four-Rail Horse Fence Installation | River Creek Fence",
  excerpt:
  ...
  overviewHeading: "Classic Board Fence Your Horses Can Actually See",
  description: [
  ...
  atAGlance: [
    { icon: "CalendarClock", label: "Lifespan", value: "20–25 years" },
    { icon: "Wrench", label: "Upkeep", value: "Paint/seal" },
    { icon: "Layers", label: "Rails", value: "4 boards" },
    { icon: "Tractor", label: "Best for", value: "Horses" },
  ],

  prosConsHeading: "Is Four-Rail Board Fence the Right Call for Your Horses?",
  pros: [
  ...
  featureHeading: "Built to Take a Kansas Pasture — and a Horse Leaning On It",
  featureBody: [
  ...
  useCases: {
    ...
    heading: "What Four-Rail Board Fence Is Built For",
    subtitle:
  ...
  buildStepsHeading: "How We Build Your Four-Rail Horse Fence",
  buildSteps: [
    {
      title: "Walk the Ground & Plan the Layout",
      description:
    ...
    {
      title: "Brace Corners & Hang the Rails",
      description:
  ...
  faqs: [
    {
      question: "Is four-rail wood fence safe for horses?",
      answer:
    ...
    {
      question: "How tall should a horse fence be, and how many rails?",
      answer:
    ...
    {
      question: "Wood or vinyl rails for a horse fence?",
      answer:
    ...
    {
      question: "How do I stop my horses from chewing the rails?",
      answer:
  ...
  ctaHeading: "Ready for Horse Fence Built by a Horseman?",
  ctaText:
    "Get a free, no-pressure estimate on a four-rail horse fence built for safety and Central Kansas weather. Call Cody today.",

  related: [
    { label: "Horse Fence Installation", href: "/property/horse-fence-installation" },
