...
const config: FenceTypeConfig = {
  ...
  h1: "Chain Link Fencing in Central Kansas",
  metaTitle: "Chain Link Fence Installation | River Creek Fence",
  excerpt:
  ...
  overviewHeading: "Tough, Affordable, and Built to Stay Put",
  description: [
  ...
  atAGlance: [
    ...
    { icon: "Wrench", label: "Upkeep", value: "Almost none" },
    { icon: "Ruler", label: "Heights", value: "4–12 ft" },
    { icon: "Dog", label: "Best for", value: "Pets & security" },
  ],

  prosConsHeading: "Is Chain Link the Right Fence for Your Property?",
  pros: [
  ...
  featureHeading: "Spec'd for Kansas Wind, Soil, and Big Yards",
  featureBody: [
  ...
  useCases: {
    ...
    items: [
      ...
      {
        title: "Commercial & Industrial Lots",
        description:
      ...
      {
        title: "Residential Property Lines",
        description:
  ...
  buildStepsHeading: "How We Install Your Chain Link Fence",
  buildSteps: [
    {
    ...
    {
      title: "Brace, Hang Rail & Stretch the Mesh",
      description:
    ...
    {
      title: "Hang Gates, Clean Up & Walk It",
      description:
  ...
  faqs: [
    {
      question: "How long does a chain link fence last in Kansas?",
      answer:
    ...
    {
      question: "Galvanized or black vinyl-coated — which should I get?",
      answer:
    ...
    {
      question: "Will a chain link fence keep my dog in the yard?",
      answer:
    ...
    {
      question: "Can a chain link fence give me privacy?",
      answer:
  ...
  ctaHeading: "Need a Yard or Lot Fenced — Without Overpaying?",
  ctaText:
    "Get a free, no-pressure estimate on a chain link fence sized for your property and built for Central Kansas weather. Call Cody today.",
