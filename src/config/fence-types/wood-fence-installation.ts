...
const config: FenceTypeConfig = {
  ...
  h1: "Wood Fence Installation in Central Kansas",
  metaTitle: "Wood Fence Installation in Kansas | River Creek Fence",
  excerpt:
  ...
  overviewHeading: "Classic Wood Fencing That Fits Your Home",
  description: [
  ...
  atAGlance: [
    ...
    { icon: "Droplets", label: "Upkeep", value: "Stain 2–3 yrs" },
    { icon: "PanelsTopLeft", label: "Styles", value: "Picket to solid" },
    { icon: "Home", label: "Best for", value: "Homes & yards" },
  ],

  prosConsHeading: "Is a Wood Fence the Right Call for Your Yard?",
  pros: [
  ...
  featureHeading: "Built to Handle Kansas Wind, Sun, and Shifting Soil",
  featureBody: [
  ...
  useCases: {
    ...
    heading: "What Homeowners Use Wood Fencing For",
    subtitle:
    ...
    items: [
      ...
      {
        title: "Open Ranch & Acreage Lines",
        description:
  ...
  buildStepsHeading: "How We Build Your Wood Fence",
  buildSteps: [
    {
  ...
  faqs: [
    {
      question: "How long does a wood fence last in Kansas?",
      answer:
    ...
    {
      question: "Treated pine or cedar — which wood should I choose?",
      answer:
    ...
    {
      question: "Do I have to stain or paint a wood fence?",
      answer:
    ...
    {
      question: "What's the best wood fence style for my house?",
      answer:
  ...
  ctaHeading: "Ready for a Wood Fence That Fits Your Yard?",
  ctaText:
    "Get a free, no-pressure estimate on a wood fence built for Central Kansas weather and your budget. Call Cody today.",

  related: [
    { label: "Cedar Privacy Fence", href: "/fence-types/cedar-privacy-fence-installation" },
