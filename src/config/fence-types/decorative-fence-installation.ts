...
const config: FenceTypeConfig = {
  slug: "decorative-fence-installation",
  title: "Decorative Fence Installation",
  h1: "Decorative Fence Installation in Central Kansas",
  metaTitle: "Decorative Fence Installation | River Creek Fence",
  excerpt:
  ...
  overviewHeading: "Curb Appeal You See From the Street",
  description: [
  ...
  atAGlance: [
    ...
    { icon: "Droplets", label: "Upkeep", value: "Very low" },
    { icon: "Eye", label: "Style", value: "Open · see-thru" },
    { icon: "Home", label: "Best for", value: "Front yards" },
  ],

  prosConsHeading: "Is a Decorative Fence the Right Accent for Your Yard?",
  pros: [
  ...
  featureHeading: "Accent Fencing Built to Stand Straight in Kansas",
  featureBody: [
  ...
  useCases: {
    ...
    heading: "What Homeowners Use Decorative Fencing For",
    subtitle:
      "From a garden edge to a dressed-up front entry, here's where an accent fence pulls its weight across Central Kansas.",
    items: [
      {
        title: "Garden & Flower Bed Borders",
        description:
          "A low ornamental run edges beds, keeps critters out, and gives the garden a crisp, finished line.",
        icon: "Leaf",
        href: "/property/garden-fence-installation",
      },
      {
        title: "Front-Yard Curb Appeal",
        description:
          "Frame the house and walkway with a tidy accent fence that lifts the look of homes across Hutchinson and Wichita.",
        icon: "Home",
        href: "/services/residential-fence-installation",
      },
      {
        title: "Custom Accent Sections",
        description:
          "Scrollwork, lattice tops, and one-off panels built to match your home — exactly where you want them.",
        icon: "Sparkles",
        href: "/services/custom-fence-installation",
      },
      {
        title: "Ornamental Metal Styles",
        description:
          "Powder-coated steel and aluminum pickets that deliver clean lines with almost no upkeep.",
        icon: "Grid3x3",
        href: "/fence-types/metal-fence-installation",
      },
      {
        title: "Classic Wrought-Iron Look",
        description:
          "Want that timeless black-iron elegance? We build wrought-iron-style fencing with finials and detail.",
        icon: "Crown",
        href: "/fence-types/wrought-iron-fence-installation",
      },
      {
        title: "Dressed-Up Pool Surrounds",
        description:
          "Pair safety-rated spacing with a decorative profile so the pool area looks as good as it is safe.",
        icon: "Waves",
  ...
  buildStepsHeading: "How We Install Your Decorative Fence",
  buildSteps: [
    {
      title: "Free On-Site Design & Layout",
      description:
    ...
    {
      title: "Hang Panels, Detail & Gates",
      description:
  ...
  faqs: [
    {
      question: "What counts as a decorative or ornamental fence?",
      answer:
    ...
    {
      question: "Will a decorative fence give me any privacy?",
      answer:
    ...
    {
      question: "Can a decorative fence keep my dog in the yard?",
      answer:
    ...
    {
      question: "Will an accent fence hold up to Kansas wind and weather?",
      answer:
  ...
  ctaHeading: "Ready to Dress Up Your Front Yard?",
  ctaText:
  ...
  related: [
    { label: "Custom Fence Installation", href: "/services/custom-fence-installation" },
    { label: "Residential Fence Installation", href: "/services/residential-fence-installation" },
    { label: "Metal Fence Installation", href: "/fence-types/metal-fence-installation" },
    { label: "Wrought Iron Fence Installation", href: "/fence-types/wrought-iron-fence-installation" },
  ],
};
