...
const config: FenceTypeConfig = {
  slug: "continuous-fence-installation",
  title: "Continuous Fence Installation",
  h1: "Continuous Fence Installation in Central Kansas",
  metaTitle: "Continuous Fence Installation | River Creek Fence",
  excerpt:
  ...
  overviewHeading: "Steel That Cattle Can't Argue With",
  description: [
  ...
  atAGlance: [
    ...
    { icon: "Wrench", label: "Upkeep", value: "Very low" },
    { icon: "Layers", label: "Rails", value: "4–6 per panel" },
    { icon: "Tractor", label: "Best for", value: "Corrals & ranch" },
  ],

  prosConsHeading: "Is Continuous Fence the Right Call for Your Operation?",
  pros: [
  ...
  featureHeading: "Built for Kansas Pasture, Wind, and Stock Pressure",
  featureBody: [
  ...
  buildStepsHeading: "How We Build Your Continuous Fence",
  buildSteps: [
    {
  ...
  faqs: [
    {
      question: "What exactly is continuous fence?",
      answer:
    ...
    {
      question: "How long does continuous fence last in Kansas?",
      answer:
    ...
    {
      question: "Is continuous fence better than barbed wire for cattle?",
      answer:
    ...
    {
      question: "Will continuous fence hold horses, goats, or smaller stock?",
      answer:
  ...
  ctaHeading: "Ready for Fence That Holds Your Stock?",
  ctaText:
    "Get a free, no-pressure estimate on continuous steel fence built for Central Kansas ranches and corrals. Call Cody today.",
  ...
  related: [
    ...
    { label: "Cattle Fence Installation", href: "/property/cattle-fence-installation" },
    { label: "Livestock Fence Installation", href: "/property/livestock-fence-installation" },
  ],
};
