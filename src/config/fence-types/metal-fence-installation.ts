...
const config: FenceTypeConfig = {
  ...
  h1: "Ornamental Metal Fencing in Central Kansas",
  metaTitle: "Metal Fence Installation | River Creek Fence",
  excerpt:
  ...
  overviewHeading: "Clean Lines, Almost Zero Upkeep",
  description: [
  ...
  atAGlance: [
    { icon: "CalendarClock", label: "Lifespan", value: "30+ years" },
    { icon: "Sparkles", label: "Upkeep", value: "Rinse, that's it" },
    { icon: "ShieldCheck", label: "Strength", value: "Steel or alum." },
    { icon: "Crown", label: "Best for", value: "Curb appeal" },
  ],

  prosConsHeading: "Is Ornamental Metal the Right Fence for You?",
  pros: [
  ...
  featureHeading: "Built to Stand Up to Kansas Wind and Sun",
  featureBody: [
  ...
  useCases: {
    ...
    heading: "What Ornamental Metal Fencing Is Used For",
    subtitle:
      "From a poolside border to a locked-down commercial yard, here's where powder-coated metal earns its place across Central Kansas.",
    items: [
      {
        title: "Pool & Spa Enclosures",
        description:
          "Code-friendly aluminum that won't rust at the waterline and keeps the pool area safe without hiding the view.",
        icon: "Waves",
      ...
      },
      {
        ...
        description:
          "Sharp, professional steel and aluminum that frames storefronts, offices, and lots across Hutchinson and Wichita.",
        icon: "Building2",
        href: "/services/commercial-fence-installation",
      },
      {
        title: "Security Perimeters",
        description:
          "Welded steel with tight pickets and tall runs to lock down yards, equipment, and high-traffic property lines.",
        icon: "Lock",
        href: "/services/security-fence-installation",
      },
      {
        title: "Wrought-Iron Looks",
        description:
          "Get the classic wrought-iron silhouette with modern powder-coated metal that won't fight you on upkeep.",
        icon: "Crown",
      ...
      },
      {
        ...
        description:
          "Define a front yard, garden, or driveway with slim ornamental panels in black, bronze, or a custom color.",
        icon: "Sparkles",
        href: "/fence-types/decorative-fence-installation",
      },
      {
        title: "Home Curb Appeal",
        description:
          "A clean metal line lifts the look and resale value of homes throughout Reno County and Central Kansas.",
        icon: "Home",
  ...
  buildStepsHeading: "How We Install Your Metal Fence",
  buildSteps: [
    {
    ...
    {
      title: "Hang & Brace Panels and Gates",
      description:
    ...
    {
      title: "Touch-Up, Cleanup & Walkthrough",
      description:
  ...
  faqs: [
    {
      question: "Should I choose aluminum or steel for my metal fence?",
      answer:
    ...
    {
      question: "Does ornamental metal fencing rust in the Kansas weather?",
      answer:
    ...
    {
      question: "How much maintenance does a metal fence really need?",
      answer:
    ...
    {
      question: "Will a metal fence hold up to Central Kansas wind?",
      answer:
  ...
  ctaHeading: "Want a Sharp Metal Fence That Looks After Itself?",
  ctaText:
    "Get a free, no-pressure estimate on powder-coated aluminum or steel fencing built for Central Kansas. Call Cody today.",

  related: [
    { label: "Commercial Fence Installation", href: "/services/commercial-fence-installation" },
    { label: "Security Fence Installation", href: "/services/security-fence-installation" },
    { label: "Decorative Fence Installation", href: "/fence-types/decorative-fence-installation" },
