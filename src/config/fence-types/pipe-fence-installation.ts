...
const config: FenceTypeConfig = {
  slug: "pipe-fence-installation",
  title: "Pipe Fence Installation",
  h1: "Pipe Fencing in Central Kansas",
  metaTitle: "Pipe Fence Installation | River Creek Fence",
  excerpt:
  ...
  overviewHeading: "Steel That Holds the Toughest Stock",
  description: [
  ...
  atAGlance: [
    { icon: "CalendarClock", label: "Lifespan", value: "30–50 years" },
    { icon: "Wrench", label: "Upkeep", value: "Paint touch-ups" },
    { icon: "ShieldCheck", label: "Strength", value: "Heavy stock" },
    { icon: "Tractor", label: "Best for", value: "Cattle & pens" },
  ],

  prosConsHeading: "Is a Welded Pipe Fence the Right Call for Your Place?",
  pros: [
  ...
  featureHeading: "Welded for Kansas Wind, Ground, and Hard Use",
  featureBody: [
  ...
  buildStepsHeading: "How We Build Your Pipe Fence",
  buildSteps: [
    {
    ...
    {
      title: "Weld Rails & Brace Corners",
      description:
    ...
    {
      title: "Grind, Prime & Final Walkthrough",
      description:
  ...
  faqs: [
    {
      question: "How long does a welded pipe fence last on a Kansas ranch?",
      answer:
    ...
    {
      question: "Is pipe fence really worth it over barbed or woven wire?",
      answer:
    ...
    {
      question: "What size pipe do you use for cattle fence?",
      answer:
    ...
    {
      question: "Can you build round pens and working facilities, not just straight runs?",
      answer:
  ...
  ctaHeading: "Ready for Fence That Holds the Herd?",
  ctaText:
    "Get a free, no-pressure estimate on welded steel pipe fence built for Central Kansas cattle and weather. Call Cody today.",
