...
const config: FenceTypeConfig = {
  slug: "pipe-fence-materials",
  title: "Pipe Fence Materials",
  h1: "Steel Pipe Fence Materials in Central Kansas",
  metaTitle: "Pipe Fence Materials in Central Kansas | River Creek Fence",
  excerpt:
  ...
  overviewHeading: "Pipe and Steel That Outlasts the Cattle Behind It",
  description: [
  ...
  atAGlance: [
    { icon: "Ruler", label: "Common sizes", value: '2-3/8" – 4-1/2"+' },
    { icon: "Layers", label: "Grades", value: "New & used pipe" },
    { icon: "CalendarClock", label: "Lead time", value: "Often same week" },
    { icon: "Truck", label: "Delivery", value: "Across Reno County" },
  ],

  prosConsHeading: "Is Steel Pipe the Right Material for Your Fence?",
  pros: [
  ...
  featureHeading: "Why Welded Pipe Beats Wire Under Livestock",
  featureBody: [
  ...
  useCases: {
    ...
    heading: "What Central Kansas Ranchers Use Our Pipe For",
    subtitle:
    ...
    items: [
      {
        ...
        icon: "Tractor",
        href: "/fence-types/pipe-fence-installation",
      },
      {
        title: "Continuous Welded Panels",
        description:
  ...
  buildStepsHeading: "How We Supply Your Pipe Fence Materials",
  buildSteps: [
    {
  ...
  faqs: [
    {
      question: "Do you sell new and used pipe, or just one?",
      answer:
    ...
    {
      question: "What pipe sizes do you stock for cattle fence?",
      answer:
    ...
    {
      question: "Can you cut and weld the pipe before delivery?",
      answer:
    ...
    {
      question: "Do you deliver pipe fence materials in Reno County?",
      answer:
    ...
    {
      question: "How much does pipe fence material cost compared to wire?",
      answer:
    ...
    {
      question: "Will the pipe rust if I leave it bare?",
      answer:
  ...
  ctaHeading: "Need Steel Pipe for Your Corral or Fence Line?",
  ctaText:
    "Get a free quote on new or used pipe, sucker rod, drill stem, or continuous panels — cut, welded, and delivered across Central Kansas. Call Cody today.",

  related: [
    { label: "Pipe Fence Installation", href: "/fence-types/pipe-fence-installation" },
    { label: "Continuous Fence Installation", href: "/fence-types/continuous-fence-installation" },
    { label: "Ranch Fence Materials", href: "/materials/ranch-fence-materials" },
