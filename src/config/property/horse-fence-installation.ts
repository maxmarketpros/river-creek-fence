...
const config: FenceTypeConfig = {
  slug: "horse-fence-installation",
  title: "Horse Fence Installation",
  h1: "Horse Fence Installation in Central Kansas",
  metaTitle: "Horse Fence Installation in Kansas | River Creek Fence",
  excerpt:
  ...
  overviewHeading: "Fencing Built Around the Horse",
  description: [
  ...
  atAGlance: [
    { icon: "ShieldCheck", label: "Priority", value: "Horse safety" },
    { icon: "Ruler", label: "Rail height", value: "54–60 in" },
    { icon: "Grid2x2", label: "Mesh", value: "No-climb 2×4" },
    { icon: "Tractor", label: "Best for", value: "Pastures & paddocks" },
  ],

  prosConsHeading: "What Makes a Good Horse Fence?",
  pros: [
  ...
  featureHeading: "Safe, Visible, and Built for Kansas Ground",
  featureBody: [
  ...
  useCases: {
    ...
    heading: "Horse Fencing for Every Part of Your Property",
    subtitle:
      "From open pasture to a tight paddock by the barn, here's where each horse-fence system earns its keep across Central Kansas.",
    items: [
      {
        title: "Four-Rail Horse Fence",
        description:
          "The classic ranch look — four smooth rails in wood or vinyl, set at safe heights and strong enough to lean on.",
        icon: "RectangleHorizontal",
        href: "/fence-types/four-rail-horse-fence-installation",
      },
      {
        title: "No-Climb Mesh Paddocks",
        description:
          "Tight 2×4 woven mesh for paddocks, foaling pens, and turnouts where a hoof can't push through or get caught.",
        icon: "Grid2x2",
        href: "/fence-types/no-climb-fence-installation",
      },
      {
        title: "Wood Ranch Rail",
        description:
          "Traditional wood ranch rail that frames the property line and gives horses a clear, visible boundary.",
        icon: "Fence",
        href: "/fence-types/wood-ranch-rail-fencing",
      },
      {
        title: "Working Ranch & Farm",
        description:
          "Full ranch fencing for larger operations — perimeter lines, cross-fencing, and heavy gates built to work.",
        icon: "Tractor",
        href: "/services/ranch-fence-installation",
      },
      {
        title: "Open Pasture Turnout",
        description:
          "Big-acreage pasture fencing that keeps horses safely contained over long runs of Central Kansas ground.",
        icon: "Wheat",
      ...
      },
      {
        ...
        description:
          "Vinyl rail for owners who want the clean look without sealing, painting, or chasing chewed boards.",
        icon: "Layers",
  ...
  buildStepsHeading: "How We Build Your Horse Fence",
  buildSteps: [
    {
    ...
    {
      title: "Set & Brace Posts Below the Frost Line",
      description:
  ...
  faqs: [
    {
      question: "What's the safest fence for horses?",
      answer:
    ...
    {
      question: "Why shouldn't I use barbed wire for horses?",
      answer:
    ...
    {
      question: "Will no-climb mesh hold up to Kansas wind and frost?",
      answer:
    ...
    {
      question: "Can you fence a paddock around my run-in shed or barn?",
      answer:
  ...
  ctaHeading: "Keep Your Horses Safe and Contained",
  ctaText:
    "Get a free, no-pressure estimate on horse fencing built safety-first for Central Kansas ground. Call Cody today.",

  related: [
    { label: "Four-Rail Horse Fence Installation", href: "/fence-types/four-rail-horse-fence-installation" },
    { label: "No-Climb Fence Installation", href: "/fence-types/no-climb-fence-installation" },
