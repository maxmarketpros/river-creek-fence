...
const config: FenceTypeConfig = {
  slug: "pool-fence-installation",
  title: "Pool Fence Installation",
  h1: "Pool Safety Fence Installation in Central Kansas",
  metaTitle: "Pool Fence Installation in Kansas | River Creek Fence",
  excerpt:
  ...
  overviewHeading: "A Pool Barrier That Keeps Kids Safe",
  description: [
  ...
  atAGlance: [
    { icon: "Ruler", label: "Min. height", value: "~4 ft barrier" },
    { icon: "Lock", label: "Gate", value: "Self-close + latch" },
    { icon: "Baby", label: "Built for", value: "Drowning prevention" },
    { icon: "ShieldCheck", label: "Standard", value: "Code-compliant" },
  ],

  prosConsHeading: "What Makes a Pool Fence Code-Compliant?",
  pros: [
  ...
  featureHeading: "Aluminum, Vinyl, Mesh, or Chain Link — Picking the Right Barrier",
  featureBody: [
  ...
  useCases: {
    ...
    heading: "Pool Fencing Options for Central Kansas Homes",
    subtitle:
    ...
    items: [
      {
        title: "Ornamental Aluminum Barriers",
        description:
      ...
      {
        title: "Fence the Whole Backyard",
        description:
      ...
      {
        title: "Residential Installs Done Right",
        description:
  ...
  buildStepsHeading: "How We Install Your Pool Safety Fence",
  buildSteps: [
    {
      title: "Free On-Site Estimate & Code Check",
      description:
    ...
    {
      title: "Build the Non-Climbable Barrier",
      description:
    ...
    {
      title: "Safety Walkthrough & Cleanup",
      description:
  ...
  faqs: [
    {
      question: "How tall does a pool fence have to be in Kansas?",
      answer:
    ...
    {
      question: "Does my pool gate really need to be self-closing and self-latching?",
      answer:
    ...
    {
      question: "Which material is best for a pool fence?",
      answer:
    ...
    {
      question: "Can you add a pool fence to my existing backyard fence?",
      answer:
  ...
  ctaHeading: "Ready to Secure Your Pool the Right Way?",
  ctaText:
    "Get a free, no-pressure estimate on a code-compliant pool safety fence built for Central Kansas families. Call Cody today.",

  related: [
    { label: "Metal & Aluminum Fence Installation", href: "/fence-types/metal-fence-installation" },
