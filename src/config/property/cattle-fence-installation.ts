...
const config: FenceTypeConfig = {
  slug: "cattle-fence-installation",
  title: "Cattle Fence Installation",
  h1: "Cattle Fence Installation in Central Kansas",
  metaTitle: "Cattle Fence Installation | River Creek Fence",
  excerpt:
  ...
  overviewHeading: "Fence That Holds Where Cattle Push Hardest",
  description: [
  ...
  atAGlance: [
    ...
    { icon: "Wrench", label: "Upkeep", value: "Low · yearly" },
    { icon: "Layers", label: "Build", value: "Wire · pipe" },
    { icon: "Tractor", label: "Best for", value: "Cattle · corrals" },
  ],

  prosConsHeading: "What Goes Into a Cattle Fence That Holds",
  pros: [
  ...
  featureHeading: "Where Cattle Fence Fails — and How We Beat It",
  featureBody: [
  ...
  buildStepsHeading: "How We Build Your Cattle Fence",
  buildSteps: [
    {
      title: "Walk the Ground & Plan the Build",
      description:
    ...
    {
      title: "Set Corners, Braces & Pipe Deep",
      description:
    ...
    {
      title: "Stretch Wire, Hang Panel & Gates",
      description:
  ...
  faqs: [
    {
      question: "What's the best fence for cattle in Central Kansas?",
      answer:
    ...
    {
      question: "How do you handle water gaps and creek crossings?",
      answer:
    ...
    {
      question: "How deep do you set posts for cattle fence?",
      answer:
    ...
    {
      question: "Can you add corrals or gates to my existing pasture fence?",
      answer:
  ...
  ctaHeading: "Ready to Fence Your Cattle the Right Way?",
  ctaText:
    "Get a free, no-pressure estimate on a cattle fence built to hold where the pressure is hardest. Call Cody today.",

  related: [
    { label: "Barbed Wire Fence Installation", href: "/fence-types/barbed-wire-fence-installation" },
    ...
    { label: "Farm Fence Installation", href: "/services/farm-fence-installation" },
  ],
};
