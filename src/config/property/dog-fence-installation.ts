...
const config: FenceTypeConfig = {
  slug: "dog-fence-installation",
  title: "Dog Fence Installation",
  h1: "Dog Fence Installation in Central Kansas",
  metaTitle: "Dog Fence Installation in Kansas | River Creek Fence",
  excerpt:
  ...
  overviewHeading: "Give Your Dog a Yard They Can't Escape",
  description: [
  ...
  atAGlance: [
    { icon: "Ruler", label: "Height", value: "4–6 ft by breed" },
    { icon: "ShieldCheck", label: "Dig guard", value: "Optional / yes" },
    { icon: "Lock", label: "Gates", value: "Self-latching" },
    { icon: "PawPrint", label: "Best for", value: "Pet owners" },
  ],

  prosConsHeading: "What Makes a Good Dog Fence?",
  pros: [
  ...
  featureHeading: "Stopping the Jumpers and the Diggers",
  featureBody: [
  ...
  useCases: {
    ...
    heading: "Dog Fence Options for Central Kansas Yards",
    subtitle:
      "Every dog and every yard is different — here are the ways we keep dogs safely contained across Reno County and beyond.",
    items: [
      {
        title: "Fence Off the Backyard",
        description:
          "Close in the backyard so your dog can be let out off-leash while the kids play and you relax on the patio.",
        icon: "Home",
        href: "/property/backyard-fence-installation",
      },
      {
        title: "Budget-Friendly Chain Link",
        description:
          "Durable, affordable, and easy to reinforce against digging — a proven choice for active and larger dogs.",
        icon: "Grid2x2",
        href: "/fence-types/chain-link-fence-installation",
      },
      {
        title: "Solid Wood Privacy",
        description:
          "A tall wood fence blocks the view, cuts barking at passersby, and is hard for most dogs to climb or see through.",
        icon: "Fence",
      ...
      },
      {
        ...
        description:
          "Smooth, chew-resistant vinyl panels give a tall, solid barrier with almost no upkeep for years to come.",
        icon: "ShieldCheck",
        href: "/fence-types/vinyl-fence-installation",
      },
      {
        title: "Whole-Home Pet Setup",
        description:
          "Pairing a dog fence with the rest of your yard? We handle the full residential install start to finish.",
        icon: "PawPrint",
        href: "/services/residential-fence-installation",
      },
      {
        title: "Compare Materials & Cost",
        description:
          "See chain link, wood, and vinyl side by side with real Central Kansas pricing before you decide.",
        icon: "Banknote",
  ...
  buildStepsHeading: "How We Build Your Dog Fence",
  buildSteps: [
    {
      title: "Free Estimate & Breed Check",
      description:
  ...
  faqs: [
    {
      question: "How tall should a dog fence be?",
      answer:
    ...
    {
      question: "How do you keep a dog from digging under the fence?",
      answer:
    ...
    {
      question: "Chain link, wood, or vinyl — which is best for dogs?",
      answer:
    ...
    {
      question: "Will a dog fence keep my dog from getting loose at the gate?",
      answer:
  ...
  ctaHeading: "Ready to Keep Your Dog Safely in the Yard?",
  ctaText:
    "Get a free, no-pressure estimate on a dog fence sized to your breed and built for Central Kansas weather. Call Cody today.",

  related: [
    { label: "Chain Link Fence Installation", href: "/fence-types/chain-link-fence-installation" },
