...
const config: FenceTypeConfig = {
  slug: "acreage-fence-installation",
  title: "Acreage Fence Installation",
  h1: "Acreage Fence Installation in Central Kansas",
  metaTitle: "Acreage Fence Installation | River Creek Fence",
  excerpt:
  ...
  overviewHeading: "Fence That Defines Your Country Property",
  description: [
  ...
  atAGlance: [
    { icon: "Mountain", label: "Acreage", value: "5–160 acres" },
    { icon: "Layers", label: "Approach", value: "Perimeter + entry mix" },
    { icon: "CalendarClock", label: "Lifespan", value: "20–40 years" },
    { icon: "Ruler", label: "Best for", value: "Country property" },
  ],

  prosConsHeading: "Is an Acreage Fence Setup Right for Your Land?",
  pros: [
  ...
  featureHeading: "Built for Kansas Wind, Soil, and Open Ground",
  featureBody: [
  ...
  useCases: {
    ...
    heading: "What Acreage Owners Use This Fencing For",
    subtitle:
      "From the entrance line to the back fence row, here's where the right mix of fence earns its keep on Central Kansas country property.",
    items: [
      {
        title: "Working Perimeter & Pasture",
        description:
          "Economical barbed or woven wire that carries the long property lines and holds stock on your back acreage.",
        icon: "Wheat",
        href: "/property/pasture-fence-installation",
      },
      {
        title: "Curb-Appeal Front Line",
        description:
          "A clean run of wood ranch rail along the road frontage that makes the place look like home from the highway.",
        icon: "Fence",
        href: "/fence-types/wood-ranch-rail-fencing",
      },
      {
        title: "Driveway Entrance & Gates",
        description:
          "A wide, heavy-set entry gate where you actually drive in, framed to read as the front door to your property.",
        icon: "DoorOpen",
        href: "/property/ranch-entry-gate-installation",
      },
      {
        title: "Classic Country Split Rail",
        description:
          "Timeless split-rail lines that mark boundaries and paddocks with an open, rural look buyers love.",
        icon: "TreePine",
        href: "/fence-types/split-rail-fence-installation",
      },
      {
        title: "Full Farm & Ranch Setups",
        description:
          "Cross-fencing, corrals, and working livestock fence for the operational side of a larger acreage.",
        icon: "Tractor",
        href: "/services/ranch-fence-installation",
      },
      {
        title: "One-Off & Mixed Designs",
        description:
          "Want to blend materials or build something that isn't off the shelf? We design custom acreage fence to fit.",
        icon: "Wrench",
        href: "/services/custom-fence-installation",
      },
    ],
  },
  ...
  buildStepsHeading: "How We Fence Your Acreage",
  buildSteps: [
    {
      title: "Free On-Site Walk & Plan",
      description:
    ...
    {
      title: "Run the Perimeter & Frontage",
      description:
    ...
    {
      title: "Hang Gates & Final Walkthrough",
      description:
  ...
  faqs: [
    {
      question: "How should I fence a large acreage on a budget?",
      answer:
    ...
    {
      question: "What's the best fence for the front entrance of a country property?",
      answer:
    ...
    {
      question: "Will a wire perimeter stay tight through Kansas winters?",
      answer:
    ...
    {
      question: "How long does an acreage fence last out here?",
      answer:
  ...
  ctaHeading: "Ready to Fence Your Acreage the Right Way?",
  ctaText:
  ...
  related: [
    ...
    { label: "Pasture Fence Installation", href: "/property/pasture-fence-installation" },
    { label: "Wood Ranch Rail Fencing", href: "/fence-types/wood-ranch-rail-fencing" },
    { label: "Ranch Entry Gate Installation", href: "/property/ranch-entry-gate-installation" },
  ],
};
